...
function BookingNow() {
  return (
    <div class="desktop-8">
      ...
      <div class="chi-nh-nh-1">Chi nhánh 1</div>
      ...
      <div class="vi-c-t-ch-c-a-b-n-s-ch-c-x-c-nh-n-khi-b-n-nh-n-c-email-x-c-nh-n">
      ...
      <div class="m-b-o-s-c-kh-e-v-th-tr-ng-t-t-cho-m-o-c-a-ch-ng-t-i-c-duy-tr-ti-u-chu-n-cao-nh-t-ch-ng-t-i-ph-i-tr-ph-ph-c-l-i-7-cho-m-i-ng-i-l-n-v-5-cho-m-i-tr-em-th-i-gian-t-ch-l-m-t-gi-nh-ng-n-u-b-n-mu-n-t-ch-l-u-h-n-vui-l-ng-li-n-h-v-i-ch-ng-t-i">
        ...
        lớn và £5 cho mỗi trẻ em. Thời gian đặt chỗ là một giờ, nhưng nếu bạn
        muốn đặt chỗ lâu hơn, vui lòng liên hệ với chúng tôi.
      </div>
    </div>
  );
}
